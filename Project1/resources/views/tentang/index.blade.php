            ...
            <div class="col-md-12">
                <form class="form-tentang" method="POST" enctype="multipart/form-data" action="/tentang/{{$about->id}}">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="alamat" placeholder="Alamat" class="form-control" id="" cols="30"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="telepon" placeholder="Email" required value="{{$about->telepon}}">
                    </div>
                    <div class="form-group">
