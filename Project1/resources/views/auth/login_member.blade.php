...
<div class="flex py-10 md:py-20 px-5 md:px-32 bg-gray-200 min-h-screen">
    <div class="flex shadow w-full flex-col-reverse lg:flex-row">
        <div class="w-full lg:w-1/2 bg-white p-10 px-5 md:px-20">
            ...
            <p class="text-gray-600">Silahkan login terlebuh dahulu sebelum memulai!</p>
            ...
            <form action="/login_member" method="POST" class="mt-10">
                ...
                <div class="my-5">
                    <button type="submit"
                        class="w-full rounded-full bg-blue-400 hover:bg-blue-600 text-white py-2">Masuk</button>
                </div>
            </form>
            <span>Tidak punya akun? <a href="/register_member" class="text-blue-400 hover:text-blue-600">Buat disini.</a></span>
        </div>
