    ...
    <div class="flex py-10 md:py-20 px-5 md:px-32 bg-gray-200 min-h-screen">
        <div class="flex shadow w-full flex-col-reverse lg:flex-row">
            <div class="w-full lg:w-1/2 bg-white p-10 px-5 md:px-20">
                <h1 class="font-bold text-xl text-gray-700">Halaman Pendaftaran</h1>
                <p class="text-gray-600">Silahkan isi semua untuk membuat akun!</p>
                <br>
                ...
                <form action="/register_member " class="mt-10" method="POST">
                    @csrf
                    <div class="my-3">
                        <label class="font-semibold" for="nama_member">Nama Pelanggan</label>
                    ...
                    <div class="my-3">
                        ...
                        <input required type="text" placeholder="yourmail@example.com" name="provinsi" id="provinsi"
                            class="block border-2 rounded-full mt-2 py-2 px-5 w-full">
                    </div>
                    <div class="my-3">
                        <label class="font-semibold" for="kabupaten">Kabupaten</label>
                        <input required type="text" placeholder="yourmail@example.com" name="kabupaten" id="kabupaten"
                            class="block border-2 rounded-full mt-2 py-2 px-5 w-full">
                    </div>
                    <div class="my-3">
                        <label class="font-semibold" for="kecamatan">Kecamatan</label>
                        <input required type="text" placeholder="yourmail@example.com" name="kecamatan" id="kecamatan"
                            class="block border-2 rounded-full mt-2 py-2 px-5 w-full">
                    </div>
                    <div class="my-3">
                        <label class="font-semibold" for="detail_alamat">Detail Alamat</label>
                        <input required type="text" placeholder="yourmail@example.com" name="detail_alamat" id="detail_alamat"
                            class="block border-2 rounded-full mt-2 py-2 px-5 w-full">
                    </div>
                    <div class="my-3">
